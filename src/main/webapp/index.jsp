  ...
  <div class="row justify-content-center m-0">
    ...
    <div class="col-lg-4">
      <div class="text-center">
        <div class="row m-0">
          <a class="btn btn-secondary btn-lg fuente-botones-index m-xl-4 my-3" href="" role="button">Ver catálogo</a>
          <a class="btn btn-secondary btn-lg fuente-botones-index m-xl-4 my-3" href="info" role="button">Sobre nosotros</a>
          <a class="btn btn-secondary btn-lg fuente-botones-index m-xl-4 my-3" href="perfil" role="button">Ver Perfil</a>
          <c:if test="${true}">
