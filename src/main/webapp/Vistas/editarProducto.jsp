        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" value="tiki" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="descripcion" class="form-control" name="descripcion" rows="3" cols="35">tiki</textarea>
                </div>
                <div class="mb-4">
