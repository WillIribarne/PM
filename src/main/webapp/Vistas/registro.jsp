    ...
    <div class="container bg-negro">
        <form action="" method="post" class="p-5 m-3">
            <div class="mb-3">
                ...
                <input type="user" class="form-control" id="usuario" aria-describedby="emailHelp">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="emailInput" name="email" placeholder="edu123@mail.com">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="telInput" name="telephone" placeholder="123-456-7890">
            </div>
            <div class="mb-3">
